...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "A five-dimensional reality engine. Walk the projection. Recover the axes. Decide whether to remain a player." },
    ],
    links: [
